...
function TrackResults({ startPeriodDate, daysLast, cycleCount }) {
  ...
  const check = (momentDate) => {
    ...
    || momentDate.isBetween(menses[0].clone().add(cycleCount * 3, "days").subtract(1, "days"), menses[1].clone().add(cycleCount * 3, "days")))
  }
  ...
  const checkHighlight = (momentDate) => {
    ...
    || momentDate.isBetween(menses[0].clone().add(cycleCount * 3, "days").subtract(1, "days"), menses[1].clone().add(cycleCount * 3, "days").subtract(1, "days")))
  }
